...
for (let i = 0; i < Number(process.env.PRIMARY_WAIT || 60); i++) {
...
init_rs "shardRS1" 27020 "shardRS1" "$SH1_CFG" 60
init_rs "shardRS2" 27023 "shardRS2" "$SH2_CFG" 60

echo "Shard replica sets verified/initialized."
